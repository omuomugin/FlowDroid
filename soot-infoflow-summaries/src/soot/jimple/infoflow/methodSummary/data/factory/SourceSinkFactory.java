...
public class SourceSinkFactory {
     ...
     * @param parameterIdx The index of the method parameter through which the source value
     *                     was obtained
     * @param accessPath   The access path describing the exact source object
     * @param gap          The gap from which this flow originated. Null if this flow did not
     ...
     * @param accessPath The access path modeling the field inside the parameter value
