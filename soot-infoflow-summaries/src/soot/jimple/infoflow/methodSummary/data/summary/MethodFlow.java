...
public class MethodFlow extends AbstractMethodSummary {
     ...
     * @param isAlias      True if the source and the sink alias, false if this is not
     *                     the case.
     * @param typeChecking True if type checking shall be performed before applying this
     *                     data flow, otherwise false
     * @param cutSubFields True if no sub fields shall be copied from the source to the
