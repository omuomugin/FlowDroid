...
public class SummarySourceSinkManager implements ISourceSinkManager {
     ...
     *
     * @param mSig              The signature of the method for which summaries shall be created
     * @param parentClass       The parent class containing the method for which summaries shall
     ...
     * @param sourceSinkFactory The {@link SourceSinkFactory} to create source and sink data
     *                          objects
     */
