...
public class CategoryDefinition implements ISourceSinkCategory {
     ...
     *
     * @param systemCategory The system-defined category
     * @param customCategory A user-defined category ID. This parameter may only be used if
     ...
     *
     * @param customCategory The user-defined category id. Category identifiers must be
     *                       unique.
     */
