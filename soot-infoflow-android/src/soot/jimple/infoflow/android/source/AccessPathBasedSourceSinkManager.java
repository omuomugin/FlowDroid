...
public class AccessPathBasedSourceSinkManager extends AndroidSourceSinkManager {
     ...
     * @param sources         The list of source methods
     * @param sinks           The list of sink methods
     * @param callbackMethods The list of callback methods whose parameters are sources
     ...
     *                        list.
     * @param config          The configuration of the data flow analyzer
     * @param layoutControls  A map from reference identifiers to the respective Android
     *                        layout controls
     */
    public AccessPathBasedSourceSinkManager(Set<SourceSinkDefinition> sources, Set<SourceSinkDefinition> sinks,
     ...
     * @param canHaveImmutableAliases Specifies if the newly tainted value can have aliases that are
