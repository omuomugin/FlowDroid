...
public class LayoutControlFactory {
     ...
     *
     * @param layoutClass The layout class in Android that implements the control
     ...
     *
     * @param loadAdditionalAttributes True to load all attributes present in the layout XML files,
