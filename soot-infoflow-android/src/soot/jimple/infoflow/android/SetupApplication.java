...
public class SetupApplication {
     ...
     * @param component The Android component for which to compute the callbacks. Pass
     ...
     * @param jimpleClass The analysis class that gives us a mapping between layout IDs
     *                    and components
     ...
     *
     * @param The class name of a component to create a main method containing
    ...
    private static class InPlaceInfoflow extends Infoflow {
         ...
         * APK files.
         *
         * @param androidPath     If forceAndroidJar is false, this is the base directory of
         *                        the platform files in the Android SDK. If forceAndroidJar
         *                        is true, this is the full path of a single android.jar
         *                        file.
         * @param forceAndroidJar True if a single platform JAR file shall be forced, false
     ...
     * Runs the data flow analysis.
     *
     * @param sourceSinkFile The full path and file name of the file containing the sources
     *                       and sinks
     * @throws IOException            Thrown if the given source/sink file could not be read.
     * @throws XmlPullParserException Thrown if the Android manifest file could not be read.
     */
     ...
     *
     * @param component The single component to include in the dummy main method. Pass
