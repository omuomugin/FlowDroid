...
public class InfoflowAndroidConfiguration extends InfoflowConfiguration {
    ...
    public static class AnalysisFileConfiguration {
         ...
         *
         * @param targetAPKFile The target APK file on which the data flow analysis shall be
         *                      conducted
         */
         ...
         *
         * @param androidPlatformDir The directory in which the Android platform JARs are located
         */
         ...
         * written
         *
         * @param outputFile The target file into which the results of the data flow analysis
         *                   shall be written
         */
    ...
    public static class CallbackConfiguration {
         ...
         *
         * @param filterThreadCallbacks True to discover callbacks registered in threads, otherwise false
         */
         ...
         * than zero indicates an infinite maximum depth.
         *
         * @param maxCallbackAnalysisDepth The maximum depth up to which to look into callback registration
         *                                 chains.
         */
    ...
    public static class SourceSinkConfiguration {
         ...
         * treated as sources.
         *
         * @param callbackSourceMode The strategy for deciding whether a certain callback parameter is
         ...
         * sources
         *
         * @param enableLifecycleSoures True if the parameters of lifecycle methods shall be considered as
         ...
         * explicitly
         *
         * @param sourceFilterMode The default mode for handling sources that have not been
         ...
         * explicitly
         *
         * @param sourceFilterMode The default mode for handling sinks that have not been configured
         *                         explicitly
         */
         ...
         * @param mode     The mode that defines whether this category shall be included or
         *                 excluded
         */
     ...
     *
     * @param oneComponentAtATime True if FlowDroid shall analyze one component at a time, otherwise
     *                            false
     */
     ...
     * picture of the app
     *
     * @param mergeDexFiles True if FlowDroid shall merge all dex files in the APK, otherwise
     *                      false
     */
