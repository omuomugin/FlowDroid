...
public class FlowDroidMemoryManager implements IMemoryManager<Abstraction, Unit> {
     ...
     * @param erasePathData  Specifies whether data for tracking paths (current statement,
     ...
     *
     * @param useAbstractionCache True if the abstraction cache shall be used, otherwise false
     */
