...
public class DefaultSourceSinkManager implements ISourceSinkManager {
     ...
     * @param parameterTaintMethods The list of methods whose parameters shall be regarded as
     *                              sources
     * @param returnTaintMethods    The list of methods whose return values shall be regarded as
     *                              sinks
     */
    public DefaultSourceSinkManager(Collection<String> sources, Collection<String> sinks,
