...
public class MethodSourceSinkDefinition extends SourceSinkDefinition {
     ...
     * @param baseObjects  The source and sink definitions for the base object on which a
     *                     method of this class is invoked
     * @param parameters   The source and sink definitions for parameters of the current
     *                     method
     * @param callType     The type of calls to define as sources or sinks
     * @param returnValues The source definitions for the return value of the current
     *                     method
     */
