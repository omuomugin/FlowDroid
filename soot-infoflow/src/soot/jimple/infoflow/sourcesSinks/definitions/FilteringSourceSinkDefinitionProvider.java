...
public class FilteringSourceSinkDefinitionProvider implements ISourceSinkDefinitionProvider {
     ...
     *
     * @param innerProvider The inner provider that creates the source/sink definitions
     *                      which are then filtered by this provider
     * @param filter        The filter that defines which sources and sinks to include
     */
