...
public abstract class BaseEntryPointCreator implements IEntryPointCreator {
     ...
     * @param gen           The local generator to be used for generating locals that hold
     *                      any additional values required for the call parameters
     * @param parentClasses The classes for which we already have instances that shall be
     *                      reused
     * @return The newly created invocation statement
     */
    protected Stmt buildMethodCall(SootMethod methodToCall, Body body, Local classLocal, LocalGenerator gen,
     ...
     * @param constructionStack The set of classes we're currently constructing. Attempts to
     *                          create a parameter of one of these classes will trigger the
     *                          constructor loop check and the respective parameter will be
     *                          substituted by null.
     * @param parentClasses     If the given type is compatible with one of the types in this
     ...
     *                          list, the already-created object is used instead of creating a
     *                          new one.
     * @param generatedLocals   The set that receives all (temporary) locals created to
     ...
     * @param constructionStack Set of classes currently being built to avoid constructor
     *                          loops
     * @param parentClasses     If a requested type is compatible with one of the types in
     *                          this list, the already-created object is used instead of
     *                          creating a new one.
     * @param generatedLocals   A set that receives the (temporary) locals that were generated
     ...
     * @param body          The body to which to add the new statements ("new" statement,
     *                      constructor call, etc.)
     * @param parentClasses If a constructor call requires an object of a type which is
     ...
     * @param body              The body to which to add the new statements ("new" statement,
     *                          constructor call, etc.)
     * @param constructionStack The stack of classes currently under construction. This is
     ...
     *                          compatible with one of the types in this list, the
     *                          already-created object is used instead of creating a new one.
     * @param tempLocals        The set that receives all generated temporary locals that were
     ...
     * @param body              The body of the dummy main method to which to add the call
     *                          statement
     ...
     * main method
     *
     * @param dummyMethodName The name for the new class containing the dummy main method
     */
     ...
     *
     * @param reuseDummyMainValue True if existing methods that conflict with the entry point to
     ...
     *
     * @param warnOnConstructorLoop True if a warning shall be written to the log when a
