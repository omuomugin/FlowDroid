...
public class AndroidEntryPointCreator extends BaseEntryPointCreator implements IEntryPointCreator {
     ...
     * methods
     *
     * @param androidClasses The list of classes to be automatically scanned for Android
     *                       lifecycle methods
     */
     ...
     * @param androidClasses        The list of classes to be automatically scanned for Android
     *                              lifecycle methods
     * @param additionalEntryPoints Additional entry points to be called during the running phase of
     ...
     * lifecycle
     *
     * @param callbackFunctions The list of callback functions to be integrated into the Android
     ...
     * @param currentClass The class for which to build the content provider lifecycle
     * @param endClassStmt The statement to which to jump after completing the lifecycle
     ...
     *
     * @param entryPoints  The list of methods to consider in this class
     * @param currentClass The class for which to build the broadcast receiver lifecycle
     * @param endClassStmt The statement to which to jump after completing the lifecycle
     * @param classLocal   The local referencing an instance of the current class
     */
     ...
     * @param endClassStmt    The statement to which to jump after completing the lifecycle
     * @param beforeClassStmt The statement right before the activity lifecycle begins
     * @param classLocal      The local referencing an instance of the current class
     */
     ...
     *
     * @param applicationClass The class in which the user-defined application is implemented
     * @param applicationLocal The local containing the instance of the user-defined application
     */
     ...
     *
     * @param currentClass      The class for which we currently build the lifecycle
     * @param referenceClasses  The classes for which no new instances shall be created, but
     *                          rather existing ones shall be used.
     * @param callbackSignature An empty string if calls to all callback methods for the given
     ...
     * @param callbackSignature An empty string if all callback methods for the given class shall
     ...
     * @param referenceClasses The classes for which no new instances shall be created, but
     *                         rather existing ones shall be used.
     * @param callbackClasses  The map between callback classes and their callback methods
     ...
     * main method.
     *
     * @param modelAdditionalMethods True if additional methods shall be modeled, otherwise false
     */
