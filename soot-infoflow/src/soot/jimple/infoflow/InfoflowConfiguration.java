...
public class InfoflowConfiguration {
    ...
    public static class PathConfiguration {
         ...
         * memory is not an issue.
         *
         * @param sequentialPathProcessing True if the path reconstruction tasks shall be run
         *                                 sequentially, false for running them in parallel
         */
         ...
         * shall be reconstructed
         *
         * @param pathReconstructionMode The mode that defines how the paths between sources and
         ...
         * propagation paths between source and sink
         *
         * @param pathBuildingAlgorithm The algorithm that shall be used for reconstructing the
         *                              propagation paths between source and sink
         */
         ...
         * discarded.
         *
         * @param maxPathsPerAbstraction The maximum number of paths that shall be recorded per
         *                               abstraction.
         */
         ...
         * reconstruction.
         *
         * @param pathReconstructionBatchSize The number of paths that shall be reconstructed in one
         *                                    batch
         */
    ...
    public static class OutputConfiguration {
         ...
         *
         * @param noPassedValues the boolean value whether passed values should be excluded
         *                       from the xml output
         */
    ...
    public static class SolverConfiguration {
         ...
         * reported.
         *
         * @param maxJoinPointAbstractions The maximum number of abstractions per join point, or -1
         ...
         * abstraction.
         *
         * @param singleJointAbstraction True to configure the solver to register only a single
     ...
     *
     * @param pathAgnosticResults True if two results shall be regarded as equal if they connect
     ...
     * the access path the reached the sink or left the source
     *
     * @param oneResultPerAP True if results shall also be distinguished based on access
     *                       paths
     */
     ...
     * shall propagate a.[next].data instead of a.next.next.data.
     *
     * @param useRecursiveAccessPaths True if recursive access paths shall be reduced, otherwise
     *                                false
     */
     ...
     * a.this$0.a.data.
     *
     * @param useThisChainReduction True if access paths including outer objects shall be reduced,
     *                              otherwise false
     */
     ...
     * flow has been found
     *
     * @param stopAfterFirstFlow True if the analysis shall stop after the first flow has been
     ...
     * implicit flows
     *
     * @param implicitFlowMode The mode that defines whether and how the solver shall handle
     *                         implicit flows
     */
     ...
     *
     * @param enableStaticFields True if assignments to static fields shall be considered,
     *                           otherwise false
     */
     ...
     *
     * @param flowSensitiveAliasing True if a flow sensitive aliasing algorithm shall be used,
     *                              otherwise false
     */
     ...
     *
     * @param enableExceptions True if taints associated with exceptions shall be tracked
     ...
     *
     * @param enableArrays True if taints associated with arrays or array elements shall
     ...
     *
     * @param enableTypeChecking True if type checking shall be performed, otherwise false
     */
     ...
     *
     * @param ignoreFlowsInSystemPackages True if flows starting or ending in system packages shall be
     ...
     * through them
     *
     * @param excludeSootLibraryClasses True to exclude Soot library classes from the data flow
     ...
     *
     * @param threadNum The maximum number of threads to be used by the solver, or -1
     ...
     * data flow analysis
     *
     * @param writeOutputFiles True if the Jimple files shall be written to disk after the
     ...
     *
     * @param logSourcesAndSinks True if the discovered sources and sinks shall be logged,
     *                           otherwise false
     */
     ...
     *
     * @param enableReflections True if reflective method calls shall be supported, otherwise
     *                          false
     */
     ...
     * will initialize the Soot instance and then return immediately.
     *
     * @param taintAnalysisEnabled True if data flow tracking shall be performed, false otherwise
     */
     ...
     * been completed.
     *
     * @param incrementalReporting True if incremental data flow results shall be available,
     *                             otherwise false
     */
     ...
     * sources together
     *
     * @param oneSourceAtATime True if the analysis shall be run with one analysis at a time,
     *                         false if the analysis shall be run with all sources together
     */
