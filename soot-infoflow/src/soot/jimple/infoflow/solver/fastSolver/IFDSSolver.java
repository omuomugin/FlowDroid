...
public class IFDSSolver<N, D extends FastSolverLinkedNode<D, N>, I extends BiDiInterproceduralCFG<N, SootMethod>>
     ...
     * @param flowFunctionCacheBuilder A valid {@link CacheBuilder} or <code>null</code> if no caching is
     ...
     * @param relatedCallSite    for call and return flows the related call statement,
     ...
     *
     * @param maxJoinPointAbstractions The maximum number of abstractions per join point, or -1 to record
     ...
     *
     * @param memoryManager The memory manager that shall be used to manage the abstractions
     */
