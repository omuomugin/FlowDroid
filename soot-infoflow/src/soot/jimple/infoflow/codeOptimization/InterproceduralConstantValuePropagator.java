...
public class InterproceduralConstantValuePropagator extends SceneTransformer {
     ...
     *
     * @param manager           The data flow manager for interacting with the solver
     * @param excludedMethods   The methods that shall be excluded. If one of these methods calls
     *                          another method with a constant argument, this argument will not be
     *                          propagated into the callee.
     * @param sourceSinkManager The SourceSinkManager to be used for not propagating constants out
     *                          of source methods
     * @param taintWrapper      The taint wrapper to be used for not breaking dummy values that
     ...
     *
     * @param removeSideEffectFreeMethods The if side-effect free methods that do not call sinks shall be
     ...
     * propagation
     *
     * @param excludeSystemClasses True if methods in system classes shall be excluded from
